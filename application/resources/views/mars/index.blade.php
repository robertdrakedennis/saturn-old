...
@section('styles')
    ...
    <link href="{{ asset('/css/mars/app.css') }}" rel="stylesheet">
...
@section('content')
    <body>
    <div class="jumbotron pageheader01" @if($setting['background_image']['enabled']) style="background-image: url({{ asset('/img/mars/app.svg') }});" @endif>
