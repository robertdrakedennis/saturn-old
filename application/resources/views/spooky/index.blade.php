...
@section('styles')
    ...
    <link href="{{ asset('/css/spooky/app.css') }}" rel="stylesheet">
...
@section('content')
    <body>
    <div class="jumbotron pageheader01" @if($setting['background_image']['enabled']) style="background-image: url({{ asset('/img/spooky/app.svg') }});" @endif>
            ...
            @foreach($teams as $team)
                    <div class="team-wrapper container">
                        <div class="teaminfo-wrapper d-flex flex-column align-items-center justify-content-center">
                            ...
                            @endif
                            <h3 class="team-fcolor">{{$team->name}}</h3>
                            <p class="team-fcolor">{{ $team->description }}</p>
                            <br>
                        </div>
                        <div class="row">
